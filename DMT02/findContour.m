function [output] = findContour( input_img_name, output_path)
% Read the Image
...
for i = 1 : pieceIndex
    ...
    rectangle('Position', ROISet{i}, 'EdgeColor', 'green', 'LineWidth', 1);
    imwrite(output{i}, strcat(output_path, num2str(i), '.jpg'));
end
hold off
